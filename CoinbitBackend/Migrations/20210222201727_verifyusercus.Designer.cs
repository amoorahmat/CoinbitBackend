...
namespace CoinbitBackend.Migrations
{
    ...
    [Migration("20210222201727_verifyusercus")]
    partial class verifyusercus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoinbitBackend.Entities.Bank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CoinbitBackend.Entities.Customer", b =>
                {
                    ...
                    b.Property<string>("selfiepic")
                        .HasColumnType("text");

                    b.Property<string>("sheba_number")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("CoinbitBackend.Entities.testtable", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CoinbitBackend.Entities.Customer", b =>
                {
                    ...
                    b.HasOne("CoinbitBackend.Entities.Bank", "bank")
                        .WithMany()
                        .HasForeignKey("bank_id");

                    b.HasOne("CoinbitBackend.Entities.User", "user")
                        .WithMany()
